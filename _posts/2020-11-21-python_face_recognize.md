...
<iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width=330 height=86 src="//music.163.com/outchain/player?type=2&id=4919429&auto=1&height=66"></iframe>

# 前言

今天一个同好问我怎么用Python做人脸识别，我一时半会儿没反应过来，还以为是用边缘计算模块（[勘智K210](https://canaan-creative.com/product/kendryteai)）进行图像识别，直接告诉人家要用TensorFlow训练模型、实现线性回归还有卷积神经网络滤波器、卷积滤码器啥的......

后面突然想起来，pip里面有轮子，我还造啥轮子，直接用就完事儿了。

环境是 Python3.5.2, GCC 5.4.0 20160609 on linux

![](http://panzhifei.fun/img/2020/11/21/01/01.jpg)

# 安装face_recognition和dlib库
...
![](http://panzhifei.fun/img/2020/11/21/01/02.png)
...
![](http://panzhifei.fun/img/2020/11/21/01/03.png)
...
![](http://panzhifei.fun/img/2020/11/21/01/04.png)

#### 识别图片中的人是谁

![](http://panzhifei.fun/img/2020/11/21/01/05.png)
...
![](http://panzhifei.fun/img/2020/11/21/01/06.gif)
...
![known](http://panzhifei.fun/img/2020/11/21/01/07.png)

然后，你需要第二个图片文件夹，文件夹里面是你希望识别的图片：

![unknown](http://panzhifei.fun/img/2020/11/21/01/08.png)
...
![案例：定位拜登的脸](http://panzhifei.fun/img/2020/11/21/01/09.png)
...
![案例：提取奥巴马和拜登的面部关键点](http://panzhifei.fun/img/2020/11/21/01/10.png)
