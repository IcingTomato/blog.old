---
layout:     post
title:      Embellishing the donut：an old-school CG cliche
subtitle:   要不，再来一个甜甜圈？
date:       2006-09-20
author:     a1k0n
header-img: img/2006/09/20/01/title.jpg
catalog: true
tags:
    - Donut
    - C
...
(as with the [first one](http://panzhifei.fun/2006/09/15/obfuscated_c_donut/), compile it with -lm, and it needs ANSI-ish terminal emulation)
